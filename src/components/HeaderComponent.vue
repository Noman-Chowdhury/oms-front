...
<template>
  <div class="header align-content-center" :class="{ expanded: isExpanded, 'expanded-in-mobile': isMobileExpanded }">
    <div class="row g-0 align-items-center">
      <div class="col-xxl-6 col-xl-5 col-4 d-flex align-items-center gap-20">
        <h3 class="px-5 primary-font">[Company Name] Dashboard</h3>
          ...
          <div class="header-collapse-group" :class="[isMobileExpanded ? 'd-block' : '']">
            <div class="header-right-btns d-flex justify-content-end align-items-center p-0">
              <form class="header-form">
                ...
                <button type="submit"><i class="fa-solid fa-magnifying-glass primary-font"></i></button>
              </form>
              <div class="header-right-btns d-flex justify-content-end align-items-center p-0">
...
<!--                </div>-->
                <div class="header-btn-box">
                  <button class="header-btn primary-font" id="notificationDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="fa-solid fa-bell animate primary-font"></i>
                ...
                <div class="header-btn-box">
                  <div class="dropdown">
                    <button class="header-btn" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                      <i class="fa-solid fa-calculator primary-font"></i>
                    </button>
                    <Calculator />
                  </div>
                </div>
                <button class="header-btn fullscreen-btn" id="btnFullscreen" @click="toggleFullscreen">
                  <i :class="isFullScreen ? 'fa-solid fa-compress primary-font' : 'fa-solid fa-desktop primary-font'"></i>
                </button>
<!--                <button class="header-btn theme-color-btn" @click="toggleTheme"><i :class="themeIconClass"></i></button>-->
          ...
          <div class="header-btn-box profile-btn-box">
            <span class="primary-font">{{   userInfoStore?.user?.name }}</span>
            <button class="profile-btn ml-5" data-bs-toggle="dropdown" aria-expanded="false">
